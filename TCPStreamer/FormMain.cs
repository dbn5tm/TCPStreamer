	...
	public partial class FormMain : Form
	{
		...
		private void Init()
		{
			try
			{
                ...
                toolTip1.SetToolTip(this.cboServerIP, "Right Click to Remove IP from DropDown");
                LoadConfig();
        ...
        {
            foreach (string ip in Properties.Settings.Default.ServerIP)
            {
		...
		private bool FormToConfig()
		{
			try
			{
                ...
                if (TextBoxClientPort.Text == "0") TextBoxClientPort.Text = "8001";
                if (TextBoxClientPort.Text == "4524") TextBoxClientPort.Text = "8001";// reserved for ORB Server
                if (TextBoxClientPort.Text == "4525") TextBoxClientPort.Text = "8001";// reserved for ORB Server
        ...
        private void StartUpServer()
        {
            ...
            {
                //Daten holen
                TextBoxServerAddress.Text = Properties.Settings.Default.StartUpIP;
                TextBoxServerPort.Text = Properties.Settings.Default.StartUpPort;
                FormToConfig();
        ...
        private void cboServerIP_Leave(object sender, EventArgs e)
        {
            string newIP = cboServerIP.Text;

            if (!Properties.Settings.Default.ServerIP.Contains(newIP))
            {
                Properties.Settings.Default.ServerIP.Add(newIP);
                Properties.Settings.Default.Save();
                cboServerIP.Items.Add(newIP);
            }
            
        }

        private void cboServerIP_MouseDown(object sender, MouseEventArgs e)
        {
            string newIP = cboServerIP.Text;  // remove this item
            if (e.Button == MouseButtons.Right)
            {
                Properties.Settings.Default.ServerIP.Remove(cboServerIP.Text);
                Properties.Settings.Default.Save();
            }
        }
        ...
        {
            TextBoxClientAddress.Text = cboServerIP.Text;
        ...
        private void chkAutoStart_CheckedChanged(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.StartUpPort = TextBoxServerPort.Text;
            Properties.Settings.Default.StartUpIP = TextBoxServerAddress.Text;
            Properties.Settings.Default.Save();
        }
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            if (chkAutoStart.Checked) StartUpServer();
        }
    }
    /// <summary>
    /// Config
